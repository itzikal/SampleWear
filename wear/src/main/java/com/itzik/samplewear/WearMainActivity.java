...
public class WearMainActivity extends Activity implements MessageApi.MessageListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, DataApi.DataListener
{
            ...
            public void onLayoutInflated(WatchViewStub stub)
            {
                ...
                mButton.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        sendMessage(WEAR_MESSAGE_PATH, "itzik");
                    }
                });
